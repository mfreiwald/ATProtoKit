...
//        let sessionURL = session.serviceEndpoint.absoluteString
        ...
        guard let requestURL = URL(string: "https://api.bsky.chat/xrpc/chat.bsky.convo.sendMessageBatch") else {
        ...
        do {
            let request = atProtoKitInstance.apiClientService.createRequest(
            ...
            let response = try await atProtoKitInstance.apiClientService.sendRequest(
                request,
